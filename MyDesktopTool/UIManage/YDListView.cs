...
public class YDListViewLite
{
    ...
    public YDListViewLite(Grid Parent, double LineHeight = 50)
    {
        ...
        OneScroll.Style = (Style)Application.Current.FindResource("for_scrollviewer");
